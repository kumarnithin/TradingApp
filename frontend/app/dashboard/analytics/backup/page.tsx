  ...
  return (
    <div className={styles.analyticsPage}>
      ...
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.pageTitle}>ðŸ“Š Trading Analytics</h1>
      ...
      <div className={styles.chartsGrid}>
        ...
        <div className={`${styles.chartPanel} glass-light`}>
          <h3 className={styles.panelTitle}>ðŸ“ˆ Equity Curve</h3>
        ...
        <div className={`${styles.chartPanel} glass-light`}>
          <h3 className={styles.panelTitle}>ðŸ“… Monthly Performance</h3>
      ...
      <div className={`${styles.strategySection} glass-light`}>
        <h3 className={styles.panelTitle}>ðŸŽ¯ Strategy Performance Comparison</h3>
              ...
              <div key={idx} className={styles.strategyCard}>
                <div className={styles.strategyHeader}>
                  ...
                  <span className={`${styles.statusBadge} ${
                    ...
                    {strategy.pnl >= 0 ? 'ðŸ“ˆ' : 'ðŸ“‰'} ${strategy.pnl.toFixed(2)}
                  </span>
                </div>
